...
export default class Queue extends Vue {
  ...
  makeColumns() {
    ...
    return {
      ...
      'JobName': { width: 150, order: 8 },

      'NodeList(Reason)': {
        width: 150,
        order: 9,
      },
      'RunTime': {width: 100, order: 10 },
      'TimeLimit': {width: 100, order: 11 },
      'SubmitTime': {width: 150, order: 12, cssClass: 'monospace right' },
      'StartTime': {width: 150, order: 13, cssClass: 'monospace right' },
      'sprio.AGE': {width: 100, order: 14},
      'sprio.FAIRSHARE': {width: 100, order: 15},
      'sprio.JOBSIZE': {width: 100, order: 16},
      'sprio.PARTITION': {width: 100, order: 17},
      'sprio.QOS': {width: 100, order: 18},
